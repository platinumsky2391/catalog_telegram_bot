...
export const sessions: Session[] = [
  {
    ...
    longInfo: {
      ...
      steps: [
        ...
        "Полный контроль. Эриксоновский и регрессивный гипноз абсолютно безопасен. Вы находитесь в диалоге, всё осознаете, можете в любой момент открыть глаза или прервать сеанс. Это похоже на глубокую расслабряющую медитацию."
      ],
